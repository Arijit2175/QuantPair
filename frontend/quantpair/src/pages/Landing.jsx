...
export default function Landing() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-cyan-700 to-slate-900 text-white">
      <div className="max-w-2xl w-full px-8 py-12 bg-white/10 rounded-3xl shadow-2xl flex flex-col items-center">
      ...
      <footer className="mt-12 text-slate-400 text-sm">&copy; {new Date().getFullYear()} QuantPair. All rights reserved.</footer>
    </div>
  );
}
