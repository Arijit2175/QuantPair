    ...
    <div className="relative min-h-screen flex flex-col bg-gradient-to-br from-slate-950 via-blue-950/5 to-slate-900 text-white overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center items-center w-full">
        <div className="max-w-2xl w-full px-8 py-16 rounded-2xl flex flex-col items-center mx-auto animate-fade-in-up border border-cyan-500/20 bg-gradient-to-b from-slate-900/40 to-slate-950/60 backdrop-blur-sm shadow-2xl">
          ...
          <p className="text-xs text-gray-300 mt-6 font-light">API-first • Low-latency • Enterprise-grade</p>
        </div>
      </div>

      <footer className="w-full flex-shrink-0 flex justify-center items-center text-gray-300 text-xs font-light pb-6">&copy; {new Date().getFullYear()} QuantPair. All rights reserved.</footer>
    </div>
  );
}
